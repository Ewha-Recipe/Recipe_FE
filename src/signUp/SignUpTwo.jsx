    ...
    <div className="container">
      ...
      <div className="signup-content">
        ...
        <div className="buttons">
          <button type="button" className="move-button" id="before-button" onClick={handleBefore}>
            이전
          </button>
          <button type="button" className="move-button" id="next-button" onClick={handleNext}>
            다음
          </button>
        </div>
      </div>
